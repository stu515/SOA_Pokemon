...
//===CREATURE DATABASE
//---CREATURES
$route['creature/(:any)'] = 'database/getAllCreatures/$1'; //get creature from db
$route['creature/(:any)/creature_information'] = 'database/getCreature/$1'; //get creature info

//---USER CREATURES
$route['user/(:any)/(:any)'] = 'database/getAllUserCreatures/$1'; //get user creature from db
$route['user/(:any)/(:any)/user_creature_information'] =  'database/getUserCreature/$1'; //show user creatures
